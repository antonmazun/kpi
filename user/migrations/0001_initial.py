    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('EDRPOU', models.IntegerField(default=123213, verbose_name='EDRPOU')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passport_serial', models.CharField(max_length=2, verbose_name='Серія паспорта')),
                ('adress', models.CharField(default=None, max_length=255, verbose_name='Адрес')),
                ('date_issue', models.DateField(verbose_name='Коли виданий')),
                ('publisher', models.CharField(default=None, max_length=255, verbose_name='Ким виданий')),
                ('id_card', models.IntegerField(verbose_name='id card')),
                ('ipn', models.IntegerField(verbose_name='Ідентифікаціонний код')),
            ],
        ),
        migrations.CreateModel(
            name='Registor',
